...
This directory contains the v1 technical specification for the 0x1 pairwise bond protocol.
...
- [Protocol Constants and Open Questions](protocol-constants-and-open-questions.md) — fixed v1 parameters and the remaining unresolved decisions.
- [Implementation Roadmap](implementation-roadmap.md) — staged delivery plan and validation gates.

## Status

**Version:** v1  
**Architecture:** Final, except for the open questions explicitly listed in [Protocol Constants and Open Questions](protocol-constants-and-open-questions.md).
